...
<head>
    ...
    <link rel="shortcut icon" href="../assets/img/logo-banner/logo-cocolux.png" type="image/x-icon">
    <!-- GOOGLE FONT -->
...
<body>
    <div class="sidebar">
        <div class="sidebar-logo">
            <img src="../assets/img/logo-banner/logo-cocolux.png" alt="Company logo">
        ...
        <div class="sidebar-user">
            <div class="sidebar-user-info">
                <img src="../assets/img/logo-banner/logo-cocolux.png" alt="User picture" class="profile-image">
                       ...
                       <div class="form-group boder">
                            ...
                            <div class="form-item">
                                ...
                                <select name="hangsx" id="hangsx">
                                    ...
                                    <option value="1">Dầu gội</option>
                                    <option value="2">Kem</option>
                                    <option value="3">Mặt nạ</option>
                                    <option value="4">Phấn</option>
